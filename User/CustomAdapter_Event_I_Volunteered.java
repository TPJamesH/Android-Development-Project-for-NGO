...
public class CustomAdapter_Event_I_Volunteered extends ArrayAdapter<Event> implements View.OnClickListener {
    ...
    public CustomAdapter_Event_I_Volunteered(ArrayList<Event> data, Context context){
        super(context, R.layout.row_item_my_volunteer_list, data);
        this.dataSet = data;
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent){
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.row_item_my_volunteer_list, parent, false);
